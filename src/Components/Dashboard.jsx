...
const Dashboard = () => {
  ...
  return (
    <>
      <div className='w-full  bg-gradient-to-br from-blue-600 to-purple-700 p-4 lg:h-screen h-full '>
        <nav className='w-full h-[60px] md:px-6 md:py-3  px-2 py-3 rounded-lg shadow-lg bg-white flex items-center justify-between mb-8'>
          ...
          <div className='flex items-center gap-4 justify-start'>
            <div className='w-[30px] h-[30px]  rounded-full bg-gradient-to-br from-blue-600 to-purple-700 flex items-center justify-center'>
          ...
          <div className='flex items-center gap-3'>
            ...
            <div onClick={() => setShow(!show)} className='w-[35px] h-[35px] text-white text-[16px] font-semibold rounded-full bg-gradient-to-b from-red-500 to-red-700 flex items-center justify-center cursor-pointer'>
              {getInitial(user?.firstName)}
            </div>
            {show && (
              <div className="absolute top-[95px] right-4 w-[250px] bg-white shadow-xl rounded-xl p-4 z-50 border border-gray-100">
                ...
                <div className="flex items-start gap-4 mb-2">
                  ...
                  <p className="text-[14px] text-gray-700 font-semibold break-words">
                    <span className=" text-gray-900"></span> {user?.firstName} {user?.lastName}
                  </p>
                </div>
                ...
                <div className="flex items-start gap-4 mb-2">
                  ...
                  <p className="text-[14px] text-gray-700 font-semibold break-words">
                    <span className="font-semibold text-gray-900"></span> {user?.email}
                  </p>
                </div>
                ...
                <div className="flex items-start gap-4 ">
                  ...
                  <p className="text-[14px] text-gray-700 font-semibold break-words">
                    <span className="font-semibold text-gray-900"></span> {user?.userName}
                  </p>
                </div>
              </div>
            )}
